...
const HOST = import.meta.env.VITE_HOST || (import.meta.env.PROD ? "" : "http://localhost:5000");
    ...
    return (
        <div className='container max-w-4xl py-4 mx-auto md:py-10'>
            <div className="text-center mb-8">
                <Heading title="Join MiniNote" description='Create your account to get started' />
                <p className="text-muted-foreground mt-2">Start organizing your thoughts today</p>
            </div>
